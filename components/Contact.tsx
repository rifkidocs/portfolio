...
export function Contact() {
  ...
  return (
    <section
      ...
      {/* Colorful blur orbs */}
      <div className='absolute top-20 left-1/4 w-80 h-80 bg-blue-500/10 dark:hidden rounded-full blur-3xl pointer-events-none' />
      <div className='absolute top-40 right-10 w-72 h-72 bg-purple-500/8 dark:hidden rounded-full blur-3xl pointer-events-none' />
      <div className='absolute bottom-20 left-10 w-64 h-64 bg-indigo-400/8 dark:hidden rounded-full blur-3xl pointer-events-none' />
